...
<div id="div1">
	...
	<div class="container-fluid">
		<h1 class="text-center text-white">Apex 150 RGB遊戲鍵盤</h1>
		<div class="row details">
			...
			<div>
				<div class="products-contact">
					<h1 class="text-left">Apex 150</h1>
					<ul class="purchase-product__list">
						<li>SteelSeries 快速壓力遊戲按鍵</li>
						<li>2000 萬次按鍵耐用度保障</li>
						<li>抗液體結構設計</li>
						<li>即時 Discord 遊戲內光源通知</li>
						<li>五區客製化 RGB 背光效果</li>
					</ul>
