...
<title>Arctis 7 - 最佳綜合遊戲耳機 2017</title>
...
<div id="div1">
	...
	<div class="container-fluid">
		<h1 class="text-center text-white">Arctis 7</h1>
		<div class="row details">
			<div>
				<div>
					<img src="../../images/details/hs-Arctis7.png" alt="">
				</div>
			</div>
			<div>
				<div class="products-contact">
					<h1 class="text-left">Arctis 7</h1>
					<ul class="purchase-product__list">
						<li>不延遲無線遊戲耳機</li>
						<li>DTS Headphone:X 7.1 環繞音效</li>
					...
					<div class="add-shop">
						<form action="<c:url value="/BuyDispatcherServlet"/>" method="get">
							<button class="btn btn-warning btn-block" name="product" value="009" id="btn1">加入購物車</button>
						</form>
					</div>
				</div>
			</div>
	...
	<div class="container container--large">
		...
		<div class="accordion__section">
			<div class="accordion__section__inner">
				...
				<div class="data-point row">
					<h6 class="data-point__label col-sm-3">有效範圍</h6>
					<p class="data-point__value col-sm-9">12公尺，40 英呎</p>
				</div>
				<div class="data-point row">
					<h6 class="data-point__label col-sm-3">耳機頻率回應</h6>
					<p class="data-point__value col-sm-9">20-20000 Hz</p>
				</div>
				<div class="data-point row">
		...
		<div class="accordion__section">
			<div class="accordion__section__inner">
				<div class="data-point row">
					...
					<p class="data-point__value col-sm-9">100Hz - 6500Hz</p>
				</div>
				<div class="data-point row">
		...
		<div class="accordion__section">
			<div class="accordion__section__inner">
				<div class="data-point row">
					...
					<p class="data-point__value col-sm-9">無線 USB 和有線類比選項單孔 3.5
						公釐，連線時的4 極插頭</p>
				</div>
				<div class="data-point row">
					<h6 class="data-point__label col-sm-3">纜線長度</h6>
					<p class="data-point__value col-sm-9">1.2m, 4ft</p>
				</div>
				<div class="data-point row">
			...
			<div class="accordion__section__inner">
				<div class="data-point row">
					...
					<p class="data-point__value col-sm-9">
						<a
							href="https://downloads.steelseriescdn.com/guides/Arctis%207_PIG_rev12_Spet8-2016.pdf">下載</a>
					</p>
				</div>
				<div class="data-point row">
					<h6 class="data-point__label col-sm-3">ARCTIS 7</h6>
					<p class="data-point__value col-sm-9"></p>
				</div>
				<div class="data-point row">
					<h6 class="data-point__label col-sm-3">無線傳送器</h6>
					<p class="data-point__value col-sm-9"></p>
				</div>
				<div class="data-point row">
					<h6 class="data-point__label col-sm-3">行動/遊戲主機纜線</h6>
					<p class="data-point__value col-sm-9"></p>
				</div>
				<div class="data-point row">
					<h6 class="data-point__label col-sm-3">Micro-USB 充電線</h6>
					<p class="data-point__value col-sm-9"></p>
				</div>
			</div>
		</div>
