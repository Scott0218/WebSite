...
<title>Apex M500 Cherry MX Red 或 Blue 機械式遊戲鍵盤</title>
...
<div id="div1">
	...
	<div class="container-fluid">
		<h1 class="text-center text-white">Apex M500</h1>
		<div class="row details">
			...
			<div>
				<div class="products-contact">
					<h1 class="text-left">Apex M500</h1>
					<ul class="purchase-product__list">
						<li>Cherry MX 機械式遊戲按鍵</li>
						<li>藍色 LED 照明</li>
						<li>運用 SteelSeries 引擎，提供您 100% 可程式化的功能</li>
					</ul>
					...
					<div class="add-shop">
						<form action="<c:url value="/BuyDispatcherServlet"/>" method="get">
							<button class="btn btn-warning btn-block" name="product" value="007" id="btn1">加入購物車</button>
						</form>
					</div>
				</div>
			</div>
