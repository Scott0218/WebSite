...
<title>Sensei 310：專為電競設計的雙手適用遊戲滑鼠</title>
...
<div id="div1">
	...
	<div class="container-fluid">
		<h1 class="text-center text-white">Sensei 310</h1>
		<div class="row details">
			<div>
				<div>
					<img src="../../images/details/ms_sensei310.png" alt="">
				</div>
			</div>
			<div>
				<div class="products-contact">
					<h1 class="text-left">Sensei 310</h1>
					<ul class="purchase-product__list">
						<li>世界首款真實 1:1 電競感應器</li>
						<li>獨家分別觸發滑鼠按鍵設計</li>
						<li>歐姆龍 5 千萬次按壓機械式按鍵</li>
						<li>具純矽膠側握的雙手適用設計</li>
					</ul>
					...
					<div class="add-shop">
						<form action="<c:url value="/BuyDispatcherServlet"/>" method="get">
							<button class="btn btn-warning btn-block" name="product" value="003" id="btn1">加入購物車</button>
						</form>
					</div>
				</div>
			</div>
		...
		<div class="accordion__section">
			<div class="accordion__section__inner">
				<div class="data-point row">
					...
					<p class="data-point__value col-sm-9">SteelSeries TrueMove3</p>
				</div>
				<div class="data-point row">
		...
		<div class="accordion__section">
			<div class="accordion__section__inner">
				...
				<div class="data-point row">
					...
					<p class="data-point__value col-sm-9">雙手靈巧</p>
				</div>
				<div class="data-point row">
					<h6 class="data-point__label col-sm-3">抓握風格</h6>
					<p class="data-point__value col-sm-9">手指或指尖</p>
				</div>
				<div class="data-point row">
					<h6 class="data-point__label col-sm-3">按鈕數</h6>
					<p class="data-point__value col-sm-9">8</p>
				</div>
				<div class="data-point row">
					<h6 class="data-point__label col-sm-3">按鍵類型</h6>
					<p class="data-point__value col-sm-9">歐姆龍機械式額定 5 千萬次按壓</p>
				</div>
				<div class="data-point row">
					<h6 class="data-point__label col-sm-3">發光特效</h6>
					<p class="data-point__value col-sm-9">2 RGB 區域，獨立控制</p>
				</div>
				<div class="data-point row">
					<h6 class="data-point__label col-sm-3">重量</h6>
					<p class="data-point__value col-sm-9">92.1 克</p>
				</div>
				<div class="data-point row">
					<h6 class="data-point__label col-sm-3">長度</h6>
					<p class="data-point__value col-sm-9">125.1 公釐</p>
				</div>
				<div class="data-point row">
					<h6 class="data-point__label col-sm-3">寬度</h6>
					<p class="data-point__value col-sm-9">60.77 公釐（前），61.77
						公釐（中），70.39 公釐（後）</p>
				</div>
				<div class="data-point row">
					<h6 class="data-point__label col-sm-3">高度</h6>
					<p class="data-point__value col-sm-9">38.95 公釐</p>
				</div>
				<div class="data-point row">
	...
	<div class="container container--large">
		...
		<div class="accordion__section">
			<div class="accordion__section__inner">
				...
				<div class="data-point row">
					<h6 class="data-point__label col-sm-3">全球觀點</h6>
					<p class="data-point__value col-sm-9">平面，圓弧</p>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="container container--large">
		...
		<div class="accordion__section">
			<div class="accordion__section__inner">
				...
				<div class="data-point row">
					<h6 class="data-point__label col-sm-3">Sensei 310 遊戲滑鼠</h6>
					<p class="data-point__value col-sm-9"></p>
				</div>
			</div>
		</div>
