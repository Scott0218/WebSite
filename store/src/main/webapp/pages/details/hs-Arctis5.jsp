...
<title>Arctis 5 - 7.1 環繞音效 RGB 遊戲耳機</title>
...
<div id="div1">
	...
	<div class="container-fluid">
		<h1 class="text-center text-white">Arctis 5</h1>
		<div class="row details">
			<div>
				<div>
					<img src="../../images/details/hs-Arctis5.png" alt="">
				</div>
			</div>
			<div>
				<div class="products-contact">
					<h1 class="text-left">Arctis 5</h1>
					<ul class="purchase-product__list">
						<li>7.1 環繞音效 RGB 遊戲耳機</li>
						<li>Prism RGB 發光特效</li>
					...
					<div class="add-shop">
						<form action="<c:url value="/BuyDispatcherServlet"/>" method="get">
							<button class="btn btn-warning btn-block" name="product" value="010" id="btn1">加入購物車</button>
						</form>
					</div>
				</div>
			</div>
	...
	<div class="container container--large">
		<h1 class="text-dark text-center" style="padding:28px">規格</h1>
	</div>
	</section>
	<section class="accordion js-collapsible" role="region">
	<div class="container container--large">
		...
		<div class="accordion__section">
			<div class="accordion__section__inner">
				<div class="data-point row">
					...
					<p class="data-point__value col-sm-9">USB 或單孔 3.5 公釐、透過內含轉接器的 4
						極插頭</p>
				</div>
				<div class="data-point row">
			...
			<div class="accordion__section__inner">
				<div class="data-point row">
					...
					<p class="data-point__value col-sm-9">
						<a
							href="https://downloads.steelseriescdn.com/guides/Arctis%205_PIG_rev9_Oct3-2016.pdf">下載</a>
					</p>
				</div>
				<div class="data-point row">
					<h6 class="data-point__label col-sm-3">ARCTIS 5</h6>
				...
				<div class="data-point row">
					<h6 class="data-point__label col-sm-3">USB ChatMix 旋鈕</h6>
					<p class="data-point__value col-sm-9"></p>
				</div>
				<div class="data-point row">
