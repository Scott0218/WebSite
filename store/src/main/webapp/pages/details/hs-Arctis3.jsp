	...
	<div class="container">
			...
			<div class="row details">
				...
				<div>
					<div class="products-contact">
						<h1 class="text-left">Arctis 3</h1>
						<span>有線玩遊戲，藍牙享生活。</span>
						<ul class="purchase-product__list">
							<li>實況有線和藍牙音效</li>
							<li>超適合任天堂 Switch 聊天和 Discord</li>
		...
		<div class="container container--large">
			...
			<div class="accordion__section">
				<div class="accordion__section__inner">
					<div class="data-point row">
						<h6 class="data-point__label col-sm-3">傳輸線連結</h6>
						<p class="data-point__value col-sm-9">4 極，3.5 公釐；個人電腦雙重 3.5 公釐</p>
					</div>
					<div class="data-point row">
						<h6 class="data-point__label col-sm-3">傳輸線長度</h6>
						<p class="data-point__value col-sm-9">1.2 公尺；3 公尺</p>
					</div>
					<div class="data-point row">
						<h6 class="data-point__label col-sm-3">藍牙版本</h6>
						<p class="data-point__value col-sm-9">4.1</p>
					</div>
					<div class="data-point row">
						<h6 class="data-point__label col-sm-3">藍牙設定</h6>
						<p class="data-point__value col-sm-9">A2DP、HFP、HSP</p>
					</div>
					<div class="data-point row">
						<h6 class="data-point__label col-sm-3">無線範圍</h6>
						<p class="data-point__value col-sm-9">30 呎，10 公尺</p>
					</div>
					<div class="data-point row">
						<h6 class="data-point__label col-sm-3">電池壽命</h6>
						<p class="data-point__value col-sm-9">聆聽時間：28 小時</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container container--large">
			...
			<div class="accordion__section">
				<div class="accordion__section__inner">
					...
					<div class="data-point row">
						<h6 class="data-point__label col-sm-3">Arctis 3 藍牙耳機</h6>
						<p class="data-point__value col-sm-9"></p>
					</div>
					<div class="data-point row">
