...
<div id="div1">
	...
	<div class="container-fluid" id="prodKeyborad">
		...
		<div class="row grid-lod effect-2" id="prodMain">
			<div class="col-md-3">
				<a href="../pages/details/apex-m750.jsp"><img src="../images/keyborad-m750.png" alt=""> </a>
				<h2>Apex M750</h2>
				<p>$149.99 美元</p>
				<p>鋁核芯機械式電競鍵盤</p>
			</div>
			<div class="col-md-3">
				<a href="../pages/details/apex-150.jsp"><img src="../images/keyborad-m150.png" alt=""></a>
				<h2>APEX 150</h2>
				<p>$129.99美元</p>
				<p>RGB 遊戲鍵盤</p>
			</div>
			<div class="col-md-3">
				<a href="../pages/details/apex-m500.jsp"><img src="../images/keyborad-m500.png" alt=""></a>
				<h2>APEX M500</h2>
				<p>$69.99 美元</p>
				<p>像專家一樣玩遊戲</p>
			</div>
			<div class="col-md-3">
				<a href="../pages/details/apex-m750-tkl.jsp"><img src="../images/keyborad-m750-tkl.png" alt=""></a>
				<h2>APEX M750 TKL</h2>
				<p>$119.99 美元</p>
				<p>精巧的機械式電競鍵盤</p>
			</div>
