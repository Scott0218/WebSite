...
<title>Rival 310 - 專為電競設計的人類工程學遊戲滑鼠</title>
...
<div id="div1">
	...
	<div class="container-fluid">
		<h1 class="text-center text-white">Rival 310</h1>
		<div class="row details">
			<div>
				<div>
					<img src="../../images/details/ms_rival310.png" alt="">
				</div>
			</div>
			<div>
				<div class="products-contact">
					<h1 class="text-left">Rival 310</h1>
					<ul class="purchase-product__list">
						<li>世界首款真實 1:1 電競感應器</li>
						<li>獨家分別觸發滑鼠按鍵設計</li>
						<li>歐姆龍 5 千萬次按壓機械式按鍵</li>
						<li>人類工程學右撇子設計，純矽膠側握</li>
					</ul>
					...
					<div class="add-shop">
						<form action="<c:url value="/BuyDispatcherServlet"/>" method="get">
							<button class="btn btn-warning btn-block" name="product" value="002" id="btn1">加入購物車</button>
						</form>
					</div>
				</div>
			</div>
		...
		<div class="accordion__section">
			<div class="accordion__section__inner">
				...
				<div class="data-point row">
					...
					<p class="data-point__value col-sm-9">掌式或爪式</p>
				</div>
				<div class="data-point row">
				...
				<div class="data-point row">
					...
					<p class="data-point__value col-sm-9">88.3 克</p>
				</div>
				<div class="data-point row">
					<h6 class="data-point__label col-sm-3">長度</h6>
					<p class="data-point__value col-sm-9">127.6 公釐</p>
				</div>
				<div class="data-point row">
					<h6 class="data-point__label col-sm-3">寬度</h6>
					<p class="data-point__value col-sm-9">57.16 公釐（前）、62.07
						公釐（中）、70.1 公釐（後）</p>
				</div>
				<div class="data-point row">
					<h6 class="data-point__label col-sm-3">高度</h6>
					<p class="data-point__value col-sm-9">41.98 公釐</p>
				</div>
				<div class="data-point row">
	...
	<div class="container container--large">
		...
		<div class="accordion__section">
			<div class="accordion__section__inner">
				...
				<div class="data-point row">
					<h6 class="data-point__label col-sm-3">Rival 310 遊戲滑鼠</h6>
					<p class="data-point__value col-sm-9"></p>
				</div>
			</div>
		</div>
