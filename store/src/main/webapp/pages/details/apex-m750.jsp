...
<title>Apex M750 鋁芯機械式電競鍵盤</title>
...
<div id="div1">
	...
	<div class="container-fluid">
		<h1 class="text-center text-white">Apex M750 鋁芯機械式電競鍵盤</h1>
		<div class="row details">
			...
			<div>
				<div class="products-contact">
					<h1 class="text-left">Apex M750</h1>
					<ul class="purchase-product__list">
						<li>純粹效能 QX2 機械式按鍵</li>
						<li>耐用的 5000 Series 鋁合金</li>
					...
					<div class="add-shop">
						<form action="<c:url value="/BuyDispatcherServlet"/>" method="get">
							<button class="btn btn-warning btn-block" name="product" value="005" id="btn1">加入購物車</button>
						</form>
					</div>
				</div>
			</div>
