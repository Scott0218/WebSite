...
<div id="div1">
	...
	<div class="container-fluid" id="prodKeyborad">
		...
		<div class="row grid-lod effect-2" id="prodMain">
			<div class="col-md-3">
				<a href="<%= request.getContextPath() %>/pages/details/ms-Rival600.jsp"><img src="<%= request.getContextPath() %>/images/mouse1.png" alt=""> </a>
				<h2>Rival 600</h2>
				<p>$89.99 美元</p>
				<p>The world’s most advanced dual sensor system</p>
			</div>
			<div class="col-md-3">
				<a href="<%= request.getContextPath() %>/pages/details/ms-Rival310.jsp"><img src="<%= request.getContextPath() %>/images/mouse2.png" alt=""></a>
				<h2>Rival 310</h2>
				<p>$69.99 美元</p>
				<p>專為電競設計的人類工程學遊戲滑鼠</p>
			</div>
			<div class="col-md-3">
				<a href="<%= request.getContextPath() %>/pages/details/ms-Sensei310.jsp"><img src="<%= request.getContextPath() %>/images/mouse3.png" alt=""></a>
				<h2>Sensei 310</h2>
				<p>$69.99 美元</p>
				<p>Ambidextrous mouse engineered for esports</p>
			</div>
			<div class="col-md-3">
				<a href="<%= request.getContextPath() %>/pages/details/ms-Rival110.jsp"><img src="<%= request.getContextPath() %>/images/mouse4.png" alt=""></a>
				<h2>Rival 110</h2>
				<p>$39.99  美元</p>
				<p>採通用抓握設計的競賽級遊戲滑鼠</p>
			</div>
